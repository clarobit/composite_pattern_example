...
현재 Device Layer는 다음과 같은 하드웨어 장치 abstraction을 제공함.

- **Bluetooth**  
UART 기반 Bluetooth 모듈 제어

- **EncoderMotor**  
PWM 모터 구동 및 encoder count 측정
...
UART 통신과 함께 Bluetooth 모듈의 전원 제어와 연결 상태 확인을 위한 GPIO를 사용함.
...
PWM 출력을 위한 Timer와 Channel, Motor 방향 제어를 위한 GPIO를 사용하는 객체를 생성함.
